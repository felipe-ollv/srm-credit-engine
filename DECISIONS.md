...
>
> As decisões abaixo estão **aceitas, com implementação pendente**, salvo quando indicado o contrário. O objetivo deste registro é tornar explícitos os trade-offs da entrega, sem apresentar intenção como funcionalidade concluída.
...
| ID | Decisão | Motivação | Consequência aceita | Gatilho de evolução |
|---|---|---|---|---|
